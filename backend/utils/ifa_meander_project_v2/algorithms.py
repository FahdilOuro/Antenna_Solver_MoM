...
def initial_ifa_parameters(a, frequence):
    c = 3e8  # Speed of light in m/s
    lambda_c = c / frequence
    return a / (20.25333 * lambda_c)
...
def optimize_ifa(msh_file, mat_file,
    ...
    while iteration <= max_iter and not converged:
        try:
            ...
            elif abs(frequence_resonance - frequence_Coupure) < 0.05 * frequence_Coupure:
    ...
    if filename_log:
        ...
        directory = os.path.dirname(filename_log)
        ...
        print(f"Optimization parameters saved to {filename_log}")
